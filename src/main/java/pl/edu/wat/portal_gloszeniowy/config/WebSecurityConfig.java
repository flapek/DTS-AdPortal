...
import pl.edu.wat.portal_gloszeniowy.security.jwt.AuthEntryPointJwt;
import pl.edu.wat.portal_gloszeniowy.security.jwt.AuthTokenFilter;
...
//        http.headers().frameOptions().disable();
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/offer/**/comments").permitAll()
                .antMatchers("/tags").permitAll()
                .antMatchers("/filters").permitAll()
                .antMatchers("/filters/**").permitAll()
                .antMatchers("/filtered_offers").permitAll()
                .antMatchers("/h2-console/**").permitAll()
